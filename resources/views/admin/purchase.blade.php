    ...
    @include('layouts.admin_sidebar')
        <div class="col-md-10 main-class">
            ...
            <div class="col-md-12 padding">
                <form class="form-horizontal" action="{{url('/ps_insert')}}" id="contact_form" role="form" method="POST"> {{-- form  --}}
                      ...
                      <div class="col-md-7 inputGroupContainer">
                          <div class="input-group">
                              <span class="input-group-addon"><i class="glyphicon glyphicon-bold"></i></span>
                                  <input id="product_brand" type="text" placeholder="Name of Brand" class="form-control" name="product_brand" value="{{ old('product_brand') }}"  autofocus required>
                          </div>
                      ...
                      <!-- Text input-->
                          <div class="col-md-2 inputGroupContainer">
                              <div class="input-group">
                                  <span class="input-group-addon"><i class="glyphicon glyphicon-leaf"></i></span>
                                      <input id="per_field" type="text" placeholder="Product Type" class="form-control" name="per_field" value="{{ old('per_field') }}"  autofocus required>
                              </div>
                        ...
                        <div class="form-group{{ $errors->has('product_quantity') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-7 inputGroupContainer">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-leaf"></i></span>
                                        <input id="product_quantity" type="text" placeholder="Product Quantity" class="form-control" name="product_quantity" value="{{ old('product_quantity') }}"  autofocus required>
                                </div>
                            ...
                            <div class="col-md-7 inputGroupContainer">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-shopping-cart"></i></span>
                                        <input id="product_p_price" type="text" placeholder="Product Price" class="form-control" name="product_p_price" value="{{ old('product_p_price') }}"  autofocus required>
                                </div>
                            ...
                            <div class="col-md-7 inputGroupContainer">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-usd"></i></span>
                                        <input id="product_sale_price" type="text" placeholder="Product Sale Price" class="form-control" name="product_sale_price" value="{{ old('product_sale_price') }}"  autofocus required>
                                </div>
